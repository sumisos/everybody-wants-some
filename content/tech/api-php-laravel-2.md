---
title: "API 重建计划 #2 PHP Laravel"
subTitle: "PHP Laravel API Rakuyo"
...
> 注意 PHP 要提前安装 `fileinfo` 扩展，并启用 `putenv` 和 `proc_open` 两个函数。  
...
> 拉取仓库配置见前文《<a href="/tech/api-typescript-express/#%E6%8B%89%E5%8F%96%E4%BB%93%E5%BA%93" target="_blank">API 重建计划 #1 Golenil</a>》，此处不再赘述。  
